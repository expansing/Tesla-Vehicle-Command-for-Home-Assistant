...
class ProxyManager:
    ...
    async def async_start(self) -> None:
        ...
        # Each configured vehicle uses the same command key generated by the flow.
    ...
    async def _legacy_ensure_binary(self) -> None:
    ...
    async def _legacy_download_binary(self, binary_key: str, binary_name: str) -> None:
        """Download binary from GitHub releases."""
        session = async_get_clientsession(self.hass)
    ...
    async def _legacy_wait_for_ready(self, timeout: float = 10.0) -> None:
        """Wait for proxy to be ready."""
        import aiohttp
